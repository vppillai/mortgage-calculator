import{D as U}from"./decimal-CNRKZ6of.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function e(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=e(n);fetch(n.href,s)}})();const u={MAX_AMORTIZATION_HIGH_RATIO:300,MAX_AMORTIZATION_CONVENTIONAL:360,MIN_AMORTIZATION:12,MIN_INTEREST_RATE:.01,MAX_INTEREST_RATE:30,MIN_PRINCIPAL:1e3,MAX_PRINCIPAL:1e7,MIN_DOWN_PAYMENT_UNDER_500K:.05,MIN_DOWN_PAYMENT_500K_TO_1M:.1,MIN_DOWN_PAYMENT_OVER_1M:.2,PAYMENT_FREQUENCIES:{MONTHLY:"monthly",BI_WEEKLY:"bi-weekly",WEEKLY:"weekly"},PAYMENTS_PER_YEAR:{monthly:12,"bi-weekly":26,weekly:52},COMPOUNDING_PERIODS_PER_YEAR:2,PREPAYMENT_FREQUENCIES:{PER_PAYMENT:"per-payment",ANNUAL:"annual",ONE_TIME:"one-time"},MAX_COMPARISON_SCENARIOS:5,DEFAULT_PAYMENT_FREQUENCY:"monthly",STORAGE_KEYS:{SCENARIOS:"mortgage-calc-scenarios",COMPARISONS:"mortgage-calc-comparisons",PREFERENCES:"mortgage-calc-preferences",CURRENT:"mortgage-calc-current"},ERROR_CODES:{INVALID_PRINCIPAL:"INVALID_PRINCIPAL",INVALID_RATE:"INVALID_RATE",INVALID_TERM:"INVALID_TERM",CALCULATION_ERROR:"CALCULATION_ERROR",COMPARISON_FULL:"COMPARISON_FULL",STORAGE_ERROR:"STORAGE_ERROR"}};class j{constructor(){this.keys=u.STORAGE_KEYS}isAvailable(){try{const t="__storage_test__";return localStorage.setItem(t,t),localStorage.removeItem(t),!0}catch{return!1}}get(t){if(!this.isAvailable())return null;try{const e=localStorage.getItem(t);return e?JSON.parse(e):null}catch(e){return console.error(`Error reading from localStorage: ${t}`,e),null}}set(t,e){if(!this.isAvailable())return!1;try{return localStorage.setItem(t,JSON.stringify(e)),!0}catch(a){return console.error(`Error writing to localStorage: ${t}`,a),!1}}remove(t){if(!this.isAvailable())return!1;try{return localStorage.removeItem(t),!0}catch(e){return console.error(`Error removing from localStorage: ${t}`,e),!1}}clear(){this.isAvailable()&&Object.values(this.keys).forEach(t=>{this.remove(t)})}saveScenarios(t){return this.set(this.keys.SCENARIOS,t)}getScenarios(){return this.get(this.keys.SCENARIOS)||[]}saveComparisons(t){return this.set(this.keys.COMPARISONS,t)}getComparisons(){return this.get(this.keys.COMPARISONS)||[]}savePreferences(t){return this.set(this.keys.PREFERENCES,t)}getPreferences(){return this.get(this.keys.PREFERENCES)||{theme:"system",locale:"en-CA",defaultPaymentFrequency:"monthly",showAdvancedOptions:!1}}saveCurrent(t){return this.set(this.keys.CURRENT,t)}getCurrent(){return this.get(this.keys.CURRENT)}}const H=new j;class K{constructor(){this.events={}}on(t,e){return this.events[t]||(this.events[t]=[]),this.events[t].push(e),()=>{this.events[t]=this.events[t].filter(a=>a!==e)}}once(t,e){const a=(...n)=>{e(...n),this.off(t,a)};this.on(t,a)}off(t,e){this.events[t]&&(this.events[t]=this.events[t].filter(a=>a!==e))}emit(t,e){this.events[t]&&this.events[t].forEach(a=>{try{a(e)}catch(n){console.error(`Error in event handler for ${t}:`,n)}})}clear(){this.events={}}listenerCount(t){return this.events[t]?this.events[t].length:0}}const y={CALCULATION_COMPLETE:"calculation:complete",THEME_CHANGED:"theme:changed",ERROR_OCCURRED:"error:occurred",NOTIFICATION:"notification:show"},h=new K,T={DEBUG:0,INFO:1,WARN:2,ERROR:3};class X{constructor(){this.level=T.WARN,this.logs=[],this.maxLogs=100}setLevel(t){this.level=T[t]||T.INFO}debug(t,e){this.level<=T.DEBUG&&(console.debug(`[DEBUG] ${t}`,e||""),this.addLog("DEBUG",t,e))}info(t,e){this.level<=T.INFO&&(console.log(`[INFO] ${t}`,e||""),this.addLog("INFO",t,e))}warn(t,e){this.level<=T.WARN&&(console.warn(`[WARN] ${t}`,e||""),this.addLog("WARN",t,e))}error(t,e){this.level<=T.ERROR&&(console.error(`[ERROR] ${t}`,e||""),this.addLog("ERROR",t,e))}addLog(t,e,a){this.logs.push({level:t,message:e,data:a,timestamp:new Date().toISOString()}),this.logs.length>this.maxLogs&&this.logs.shift()}getLogs(){return[...this.logs]}clearLogs(){this.logs=[]}exportLogs(){return JSON.stringify(this.logs,null,2)}}const R=new X;U.set({precision:20,rounding:U.ROUND_HALF_UP,toExpNeg:-7,toExpPos:21,minE:-9e15,maxE:9e15});function m(r){return new U(r)}function E(r,t){return m(r).plus(m(t))}function p(r,t){return m(r).minus(m(t))}function L(r,t){return m(r).times(m(t))}function x(r,t){return m(r).dividedBy(m(t))}function M(r,t){return m(r).pow(m(t))}function f(r,t=2){return m(r).toDecimalPlaces(t).toNumber()}class Z extends Error{constructor(t,e){super(t),this.name="MortgageCalculatorError",this.code=e}}class Q extends Z{constructor(t){super(t,u.ERROR_CODES.CALCULATION_ERROR),this.name="CalculationError"}}function B(r){try{const{principal:t,interestRate:e,amortizationMonths:a,paymentFrequency:n}=r,s=x(e,100),i=x(s,2),l=u.PAYMENTS_PER_YEAR[n],d=E(1,i),o=p(M(d,2),1),F=E(1,o),I=p(M(F,x(1,l)),1),k=L(a,x(l,12)),O=E(1,I),C=M(O,k),v=L(I,C),_=p(C,1),b=L(t,x(v,_)),g=L(b,k),S=p(g,t),w=new Date,P=new Date(w);return P.setMonth(P.getMonth()+parseInt(a)),{regularPayment:f(b,2),totalPayments:f(k,0),totalInterest:f(S,2),totalCost:f(g,2),payoffDate:P.toISOString().split("T")[0],effectiveRate:f(I,6)}}catch(t){throw new Q(`Failed to calculate mortgage: ${t.message}`)}}function J(r){const{principal:t,interestRate:e,amortizationMonths:a,paymentFrequency:n}=r,s=B(r),i=m(s.regularPayment),l=[];let d=m(t);const o=x(e,100),F=x(o,2),I=E(1,F),k=p(M(I,2),1),O=u.PAYMENTS_PER_YEAR[n],C=E(1,k),v=p(M(C,x(1,O)),1),_=Math.ceil(s.totalPayments),b=new Date;for(let g=1;g<=_;g++){const S=L(d,v),w=p(i,S);d=p(d,w),d.lessThan(0)&&(d=m(0));const P=new Date(b),Y=Math.floor(g*12/O);if(P.setMonth(P.getMonth()+Y),l.push({paymentNumber:g,paymentDate:P.toISOString().split("T")[0],principalPayment:f(w,2),interestPayment:f(S,2),totalPayment:f(i,2),remainingBalance:f(d,2)}),d.equals(0))break}return l}function V(r){const{principal:t,interestRate:e,amortizationMonths:a,paymentFrequency:n,extraPayment:s,extraPaymentFrequency:i}=r,l=B({principal:t,interestRate:e,amortizationMonths:a,paymentFrequency:n}),d=x(e,100),o=x(d,2),F=E(1,o),I=p(M(F,2),1),k=u.PAYMENTS_PER_YEAR[n],O=E(1,I),C=p(M(O,x(1,k)),1);let v=m(t);const _=m(l.regularPayment);let b=0,g=m(0);const S=1e4;for(;v.greaterThan(0)&&b<S;){b++;const D=L(v,C);g=E(g,D);let $=p(_,D),q=m(0);(i==="per-payment"||i==="annual"&&b%k===0||i==="one-time"&&b===1)&&(q=m(s)),$=E($,q),$.greaterThan(v)&&($=v),v=p(v,$)}const w=Math.ceil(b/k*12),P=p(l.totalInterest,g),Y=a-w;return{actualPayoffMonths:w,totalInterestSaved:f(P,2),monthsSaved:Y,totalCostWithPrepayment:f(E(t,g),2),originalTotalCost:l.totalCost,savingsPercentage:f(x(P,l.totalInterest).times(100),2)}}const tt=new Intl.NumberFormat("en-CA",{style:"currency",currency:"CAD",minimumFractionDigits:2,maximumFractionDigits:2});function c(r){return r==null||isNaN(r)?"$0.00":tt.format(r)}const A={PRINCIPAL_TOO_LOW:`Loan amount must be at least ${c(u.MIN_PRINCIPAL)}`,PRINCIPAL_TOO_HIGH:`Loan amount cannot exceed ${c(u.MAX_PRINCIPAL)}`,RATE_TOO_LOW:`Interest rate must be at least ${u.MIN_INTEREST_RATE}%`,RATE_TOO_HIGH:`Interest rate cannot exceed ${u.MAX_INTEREST_RATE}%`,TERM_TOO_SHORT:"Amortization period must be at least 1 year",TERM_TOO_LONG_HIGH_RATIO:"High-ratio mortgages (over 80% LTV) cannot exceed 25 years",TERM_TOO_LONG_CONVENTIONAL:"Conventional mortgages cannot exceed 30 years",INVALID_PAYMENT_FREQUENCY:"Please select a valid payment frequency"};function et(r){const t=[],e=[],a={},{principal:n,interestRate:s,amortizationMonths:i,paymentFrequency:l,isHighRatio:d}=r;if(n<u.MIN_PRINCIPAL){const o="PRINCIPAL_TOO_LOW";t.push(o),a.principal=A[o]}if(n>u.MAX_PRINCIPAL){const o="PRINCIPAL_TOO_HIGH";t.push(o),a.principal=A[o]}if(s<u.MIN_INTEREST_RATE){const o="RATE_TOO_LOW";t.push(o),a.interestRate=A[o]}if(s>u.MAX_INTEREST_RATE){const o="RATE_TOO_HIGH";t.push(o),a.interestRate=A[o]}if(i<u.MIN_AMORTIZATION){const o="TERM_TOO_SHORT";t.push(o),a.amortizationMonths=A[o]}if(d&&i>u.MAX_AMORTIZATION_HIGH_RATIO){const o="TERM_TOO_LONG_HIGH_RATIO";t.push(o),a.amortizationMonths=A[o]}else if(i>u.MAX_AMORTIZATION_CONVENTIONAL){const o="TERM_TOO_LONG_CONVENTIONAL";t.push(o),a.amortizationMonths=A[o]}if(!u.PAYMENTS_PER_YEAR[l]){const o="INVALID_PAYMENT_FREQUENCY";t.push(o),a.paymentFrequency=A[o]}return{isValid:t.length===0,errors:t,warnings:e,fieldErrors:a,errorMessages:t.map(o=>A[o]||o)}}function at(r){if(r=r.replace(/\s/g,""),!/^[0-9+\-*/().,]+$/.test(r))return null;r=r.replace(/,/g,"");try{const t=Function('"use strict"; return ('+r+")")();return typeof t=="number"&&!isNaN(t)&&isFinite(t)?Math.round(t*100)/100:null}catch{return null}}function st(r){return/[+\-*/()]/.test(r)}function rt(r){if(!r||r.length===0)return"";try{const t=r.map(a=>{const n=[a.principal,Math.round(a.interestRate*100),a.amortizationMonths,a.paymentFrequency.charAt(0),a.extraPaymentAmount||0];return a.extraPaymentFrequency!=="per-payment"&&n.push(a.extraPaymentFrequency==="annual"?"a":"o"),n.join("|")}).join(";");return btoa(t).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}catch(t){return console.error("Error encoding scenarios:",t),""}}function nt(r){if(!r)return[];try{const t=r.replace(/-/g,"+").replace(/_/g,"/")+"==".substring(0,(4-r.length%4)%4);return atob(t).split(";").map(n=>{const s=n.split("|");return{principal:parseFloat(s[0]),interestRate:parseFloat(s[1])/100,amortizationMonths:parseInt(s[2]),paymentFrequency:s[3]==="w"?"weekly":s[3]==="b"?"bi-weekly":"monthly",extraPaymentAmount:parseFloat(s[4])||0,extraPaymentFrequency:s[5]==="a"?"annual":s[5]==="o"?"one-time":"per-payment"}})}catch(t){return console.error("Error decoding scenarios:",t),[]}}function it(r){const t=rt(r);return t?`${window.location.href.split("?")[0]}?s=${t}`:window.location.href.split("?")[0]}function ot(){const t=new URLSearchParams(window.location.search).get("s");return nt(t)}function lt(){const r=new URL(window.location);r.searchParams.delete("s"),window.history.replaceState({},document.title,r.pathname)}async function ct(r){try{if(navigator.clipboard&&window.isSecureContext)return await navigator.clipboard.writeText(r),!0;{const t=document.createElement("textarea");t.value=r,t.style.position="fixed",t.style.left="-999999px",document.body.appendChild(t),t.select();const e=document.execCommand("copy");return document.body.removeChild(t),e}}catch(t){return console.error("Failed to copy to clipboard:",t),!1}}class dt{constructor(t){if(this.container=document.getElementById(t),!this.container){console.error(`Container with id '${t}' not found`);return}this.state={principal:298e3,interestRate:4.05,amortizationMonths:360,paymentFrequency:"weekly",targetPayment:null,extraPaymentAmount:0,extraPaymentFrequency:"per-payment"},this.result=null,this.prepaymentResult=null,this.scenarios=[],this.validationErrors=null,this.isCalculating=!1,this.loadSharedScenarios(),this.render(),this.attachEventListeners(),this.calculateAll()}render(){var t;this.container.innerHTML=`
    ...
    `:this.validationErrors&&this.validationErrors.isValid===!1?`
      ...
      <div class="mt-4 p-3 ${n?"bg-green-50 dark:bg-green-900/20":"bg-red-50 dark:bg-red-900/20"} rounded-lg">
        <p class="text-sm ${n?"text-green-800 dark:text-green-200":"text-red-800 dark:text-red-200"}">
          ${n?`✓ You can afford this mortgage! Your target is ${c(Math.abs(e))} (${Math.abs(a)}%) higher.`:`✗ Target payment is ${c(Math.abs(e))} (${Math.abs(a)}%) below required.`}
        </p>
        ${n&&e>10?`
    ...
    `}renderPrepaymentImpact(){if(!this.result)return`
        ...
        `;const t=this.prepaymentResult,e=Math.floor(t.monthsSaved/12),a=t.monthsSaved%12,n=this.state.extraPaymentFrequency==="per-payment"?this.result.regularPayment+this.state.extraPaymentAmount:this.result.regularPayment,s=Math.floor(t.actualPayoffMonths/12),i=t.actualPayoffMonths%12,l=Math.floor(this.state.amortizationMonths/12),d=this.state.amortizationMonths%12;return`
    ...
    `}renderComparisonTable(){return this.scenarios.length===0?`
                        ...
                        ${this.scenarios.map((t,e)=>`
                            <tr class="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="text-right py-2 px-2 sm:px-3">
                                    ${(()=>{if(t.savings>0){const a=this.scenarios[0],s=(a?a.payoffMonths:t.amortizationMonths)-t.payoffMonths,i=Math.floor(s/12),l=s%12;return`
                                                <div>
                                ...
                                <td class="text-center py-2 px-2 sm:px-3">
                                    <button class="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 text-lg focus:outline-none focus:ring-2 focus:ring-red-500 rounded"
                                            ...
                                            aria-label="Remove scenario ${t.name}">
        ...
        `}attachEventListeners(){["principal","interestRate","amortizationYears","paymentFrequency","extraPayment","extraPaymentFrequency"].forEach(s=>{const i=document.getElementById(s);i&&(i.addEventListener("input",l=>{this.handleInputChange(l),this.calculateAll()}),i.tagName==="SELECT"&&i.addEventListener("change",l=>{this.handleInputChange(l),this.calculateAll()}),s==="extraPayment"&&(i.addEventListener("keydown",l=>{l.key==="Enter"&&(l.preventDefault(),this.evaluateExtraPayment())}),i.addEventListener("blur",()=>{this.evaluateExtraPayment()})))});const e=document.getElementById("reset");e&&e.addEventListener("click",()=>this.handleReset());const a=document.getElementById("add-to-comparison");a&&a.addEventListener("click",()=>this.addToComparison()),window.removeScenario=s=>{this.scenarios.splice(s,1),this.updateComparisonSection(),this.attachShareButtonListener()},this.attachShareButtonListener();const n=document.getElementById("view-schedule");n&&n.addEventListener("click",()=>{this.result&&h.emit("schedule:show",this.state)})}handleInputChange(t){const{id:e,value:a}=t.target;switch(e){case"principal":this.state.principal=parseFloat(a)||0;break;case"interestRate":this.state.interestRate=parseFloat(a)||0;break;case"amortizationYears":this.state.amortizationMonths=(parseInt(a)||0)*12;break;case"paymentFrequency":this.state.paymentFrequency=a;break;case"targetPayment":this.state.targetPayment=a?parseFloat(a):null;break;case"extraPayment":break;case"extraPaymentFrequency":this.state.extraPaymentFrequency=a;break}}calculateAll(){clearTimeout(this.calculationTimeout),this.calculationTimeout=setTimeout(()=>{this.performCalculations()},300)}performCalculations(){this.isCalculating=!0;const t=et(this.state);if(!t.isValid){this.result=null,this.prepaymentResult=null,this.validationErrors=t,this.isCalculating=!1,t.errorMessages&&t.errorMessages.length>0&&h.emit(y.NOTIFICATION,{message:t.errorMessages[0],type:"error"}),this.updateResults(),this.updateValidationErrors(t.fieldErrors);return}this.validationErrors=null,this.clearValidationErrors();try{this.result=B(this.state),this.state.extraPaymentAmount>0?this.prepaymentResult=V({...this.state,extraPayment:this.state.extraPaymentAmount,extraPaymentFrequency:this.state.extraPaymentFrequency}):this.prepaymentResult=null,this.updateResults(),h.emit(y.CALCULATION_COMPLETE,{inputs:this.state,result:this.result,prepaymentResult:this.prepaymentResult}),this.isCalculating=!1}catch(e){R.error("Calculation failed",e),this.result=null,this.prepaymentResult=null,this.isCalculating=!1,this.updateResults(),h.emit(y.NOTIFICATION,{message:"An error occurred during calculation. Please check your inputs and try again.",type:"error"})}}updateValidationErrors(t){t&&Object.keys(t).forEach(e=>{const a=document.getElementById(e),n=t[e];if(a){a.classList.add("border-red-500","dark:border-red-600"),a.classList.remove("border-gray-300","dark:border-gray-600");let s=a.parentElement.querySelector(".field-error");s||(s=document.createElement("div"),s.className="field-error text-xs text-red-600 dark:text-red-400 mt-1",s.setAttribute("role","alert"),s.setAttribute("aria-live","polite"),a.parentElement.appendChild(s)),s.textContent=n,s.setAttribute("aria-label",`Error: ${n}`)}})}clearValidationErrors(){["principal","interestRate","amortizationYears","paymentFrequency","extraPayment"].forEach(e=>{const a=document.getElementById(e);if(a){a.classList.remove("border-red-500","dark:border-red-600"),a.classList.add("border-gray-300","dark:border-gray-600");const n=a.parentElement.querySelector(".field-error");n&&n.remove()}})}updateResults(){const t=document.querySelector("#base-mortgage-results");t&&(t.innerHTML=this.renderMainResults());const e=document.querySelector("#prepayment-section");e&&(this.prepaymentResult&&this.state.extraPaymentAmount>0?e.innerHTML=`
          <div class="bg-green-50 dark:bg-green-900/20 rounded-xl shadow-lg p-4 sm:p-6">
            <h3 class="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-green-900 dark:text-green-100">
              Prepayment Impact
            </h3>
        ...
        `:e.innerHTML="");const a=document.querySelector("#inline-comparison-table");a&&(a.innerHTML=this.renderComparisonTable())}updateComparisonSection(){const t=document.querySelector("#inline-comparison-table");if(!t)return;const e=t.closest(".bg-white.dark\\:bg-gray-800.rounded-xl.shadow-lg");if(e){e.innerHTML=`
            ...
            `;const a=document.getElementById("add-to-comparison");a&&a.addEventListener("click",()=>this.addToComparison())}}handleReset(){this.state={principal:298e3,interestRate:4.05,amortizationMonths:360,paymentFrequency:"weekly",targetPayment:null,extraPaymentAmount:0,extraPaymentFrequency:"per-payment"},this.result=null,this.prepaymentResult=null,this.render(),this.attachEventListeners(),this.calculateAll()}evaluateExtraPayment(){const t=document.getElementById("extraPayment");if(!t)return;const e=t.value.trim();if(!e){this.state.extraPaymentAmount=0,this.calculateAll();return}if(st(e)){const a=at(e);a!==null?a<0?(h.emit(y.NOTIFICATION,{message:`${e} = ${a} (must be positive)`,type:"error"}),this.state.extraPaymentAmount=0,t.value=0):(this.state.extraPaymentAmount=a,t.value=a,this.calculateAll(),h.emit(y.NOTIFICATION,{message:`Calculated: ${e} = ${a}`,type:"info"})):h.emit(y.NOTIFICATION,{message:"Invalid expression. Use numbers and +, -, *, /, ()",type:"error"})}else{const a=parseFloat(e);!isNaN(a)&&a>=0?(this.state.extraPaymentAmount=a,this.calculateAll()):a<0&&(this.state.extraPaymentAmount=0,t.value=0,h.emit(y.NOTIFICATION,{message:"Extra payment must be positive",type:"error"}))}}addToComparison(){if(!this.result)return;this.scenarios.find(s=>s.extraPaymentAmount===0);let t=this.result.regularPayment;this.state.extraPaymentAmount>0&&this.state.extraPaymentFrequency==="per-payment"&&(t+=this.state.extraPaymentAmount);let e="";if(this.scenarios.length===0)e="Base Scenario";else{const s=this.scenarios[0],i=[];this.state.principal!==s.principal&&i.push(`${c(this.state.principal)}`),this.state.interestRate!==s.interestRate&&i.push(`${this.state.interestRate}%`),this.state.amortizationMonths!==s.amortizationMonths&&i.push(`${this.state.amortizationMonths/12}yr`),this.state.paymentFrequency!==s.paymentFrequency&&i.push(this.state.paymentFrequency),this.state.extraPaymentAmount>0&&i.push(`+${c(this.state.extraPaymentAmount)}`),e=i.length>0?i.join(", "):"Scenario "+(this.scenarios.length+1)}const a={name:e,basePayment:this.result.regularPayment,totalPayment:t,extraPaymentAmount:this.state.extraPaymentAmount,extraPaymentFrequency:this.state.extraPaymentFrequency,totalInterest:this.prepaymentResult&&this.state.extraPaymentAmount>0?this.result.totalInterest-this.prepaymentResult.totalInterestSaved:this.result.totalInterest,totalCost:this.prepaymentResult&&this.state.extraPaymentAmount>0?this.prepaymentResult.totalCostWithPrepayment:this.result.totalCost,payoffMonths:this.prepaymentResult&&this.state.extraPaymentAmount>0&&this.prepaymentResult.actualPayoffMonths?this.prepaymentResult.actualPayoffMonths:this.state.amortizationMonths,savings:0,principal:this.state.principal,interestRate:this.state.interestRate,amortizationMonths:this.state.amortizationMonths,paymentFrequency:this.state.paymentFrequency};if(this.scenarios.some(s=>s.principal===a.principal&&s.interestRate===a.interestRate&&s.amortizationMonths===a.amortizationMonths&&s.paymentFrequency===a.paymentFrequency&&s.extraPaymentAmount===a.extraPaymentAmount&&s.extraPaymentFrequency===a.extraPaymentFrequency))h.emit(y.NOTIFICATION,{message:"This scenario already exists in comparison",type:"info"});else{if(this.scenarios.push(a),this.scenarios.length>1){const s=this.scenarios[0];this.scenarios.forEach(i=>{i.savings=s.totalCost-i.totalCost})}this.updateComparisonSection(),h.emit(y.NOTIFICATION,{message:"Added to comparison!",type:"success"}),this.attachShareButtonListener()}}loadSharedScenarios(){try{const t=ot();if(t&&t.length>0){if(this.scenarios=[],t.forEach((e,a)=>{const n=B({principal:e.principal,interestRate:e.interestRate,amortizationMonths:e.amortizationMonths,paymentFrequency:e.paymentFrequency});let s=null;e.extraPaymentAmount>0&&(s=V({principal:e.principal,interestRate:e.interestRate,amortizationMonths:e.amortizationMonths,paymentFrequency:e.paymentFrequency,extraPayment:e.extraPaymentAmount,extraPaymentFrequency:e.extraPaymentFrequency}));let i=a===0?"Base Mortgage":"";if(a>0){const d=t[0],o=[];e.principal!==d.principal&&o.push(`${c(e.principal)} loan`),e.interestRate!==d.interestRate&&o.push(`${e.interestRate}% rate`),e.amortizationMonths!==d.amortizationMonths&&o.push(`${e.amortizationMonths/12}yr`),e.paymentFrequency!==d.paymentFrequency&&o.push(e.paymentFrequency),e.extraPaymentAmount>0&&o.push(`+${c(e.extraPaymentAmount)}`),i=o.slice(0,2).join(", ")}else e.extraPaymentAmount>0&&(i=`Base + ${c(e.extraPaymentAmount)}`);const l={name:i,principal:e.principal,interestRate:e.interestRate,amortizationMonths:e.amortizationMonths,paymentFrequency:e.paymentFrequency,extraPaymentAmount:e.extraPaymentAmount,extraPaymentFrequency:e.extraPaymentFrequency,regularPayment:n.regularPayment,totalPayment:n.regularPayment+(e.extraPaymentAmount||0),totalInterest:(s==null?void 0:s.totalInterest)||n.totalInterest,totalCost:(s==null?void 0:s.totalCost)||n.totalCost,payoffMonths:(s==null?void 0:s.actualPayoffMonths)||e.amortizationMonths,savings:0};this.scenarios.push(l)}),this.scenarios.length>0){const e=this.scenarios[0];this.scenarios.forEach(a=>{a.savings=e.totalCost-a.totalCost})}if(t[0]){const e=t[0];this.state.principal=e.principal,this.state.interestRate=e.interestRate,this.state.amortizationMonths=e.amortizationMonths,this.state.paymentFrequency=e.paymentFrequency,this.state.extraPaymentAmount=e.extraPaymentAmount||0,this.state.extraPaymentFrequency=e.extraPaymentFrequency||"per-payment"}lt(),h.emit(y.NOTIFICATION,{message:`Loaded ${t.length} shared scenario${t.length>1?"s":""}!`,type:"success"})}}catch(t){R.error("Failed to load shared scenarios:",t)}}attachShareButtonListener(){const t=document.getElementById("share-scenarios");t&&t.addEventListener("click",()=>this.shareScenarios())}async shareScenarios(){if(this.scenarios.length===0){h.emit(y.NOTIFICATION,{message:"No scenarios to share",type:"info"});return}try{const t=it(this.scenarios);await ct(t)?h.emit(y.NOTIFICATION,{message:"Share link copied to clipboard!",type:"success"}):prompt("Copy this link to share:",t)}catch(t){R.error("Failed to generate share link:",t),h.emit(y.NOTIFICATION,{message:"Failed to generate share link",type:"error"})}}}class mt{constructor(t){this.container=document.getElementById(t),this.schedule=[],this.pageSize=50,this.currentPage=0}show(t){this.schedule=J(t),this.currentPage=0,this.render()}render(){if(this.schedule.length===0){this.container.innerHTML="";return}const t=this.currentPage*this.pageSize,e=Math.min(t+this.pageSize,this.schedule.length),a=this.schedule.slice(t,e);this.container.innerHTML=`
      <div class="card mt-6">
    ...
    `,this.attachEventListeners()}attachEventListeners(){const t=document.getElementById("close-schedule");t&&t.addEventListener("click",()=>{this.container.innerHTML=""});const e=document.getElementById("prev-page");e&&e.addEventListener("click",()=>{this.currentPage>0&&(this.currentPage--,this.render())});const a=document.getElementById("next-page");a&&a.addEventListener("click",()=>{const s=Math.ceil(this.schedule.length/this.pageSize)-1;this.currentPage<s&&(this.currentPage++,this.render())});const n=document.getElementById("download-schedule");n&&n.addEventListener("click",()=>{this.downloadCSV()})}downloadCSV(){const t=["Payment #","Date","Principal","Interest","Total Payment","Remaining Balance"],e=this.schedule.map(l=>[l.paymentNumber,l.paymentDate,l.principalPayment,l.interestPayment,l.totalPayment,l.remainingBalance]),a=[t.join(","),...e.map(l=>l.join(","))].join(`
`),n=new Blob([a],{type:"text/csv"}),s=URL.createObjectURL(n),i=document.createElement("a");i.href=s,i.download=`amortization-schedule-${new Date().toISOString().split("T")[0]}.csv`,i.click(),URL.revokeObjectURL(s)}}class ut{constructor(){this.modalId="info-modal",this.isOpen=!1,this.render(),this.attachEventListeners()}render(){const t=document.createElement("div");t.id=this.modalId,t.className="fixed inset-0 z-50 hidden",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-labelledby","modal-title"),t.setAttribute("aria-describedby","modal-description"),t.innerHTML=`
        ...
        `,document.body.appendChild(t)}attachEventListeners(){const t=document.getElementById("close-info-modal"),e=document.getElementById("modal-backdrop");t&&t.addEventListener("click",()=>this.close()),e&&e.addEventListener("click",()=>this.close()),document.addEventListener("keydown",a=>{a.key==="Escape"&&this.isOpen&&this.close()})}open(){const t=document.getElementById(this.modalId);if(t){t.classList.remove("hidden"),this.isOpen=!0,document.body.style.overflow="hidden",this.previouslyFocused=document.activeElement;const e=document.getElementById("close-info-modal");e&&e.focus(),this.setupFocusTrap(t)}}close(){const t=document.getElementById(this.modalId);t&&(t.classList.add("hidden"),this.isOpen=!1,document.body.style.overflow="",this.removeFocusTrap(),this.previouslyFocused&&typeof this.previouslyFocused.focus=="function"&&this.previouslyFocused.focus())}setupFocusTrap(t){const e=t.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');e.length!==0&&(this.firstFocusable=e[0],this.lastFocusable=e[e.length-1],this.handleTabKey=a=>{a.key==="Tab"&&(a.shiftKey?document.activeElement===this.firstFocusable&&(a.preventDefault(),this.lastFocusable.focus()):document.activeElement===this.lastFocusable&&(a.preventDefault(),this.firstFocusable.focus()))},t.addEventListener("keydown",this.handleTabKey))}removeFocusTrap(){if(this.handleTabKey){const t=document.getElementById(this.modalId);t&&t.removeEventListener("keydown",this.handleTabKey),this.handleTabKey=null}}}const N={calculator:null,amortizationSchedule:null,infoModal:null};function ht(){const r=H.getPreferences(),t=r.theme||"system";(t==="dark"||t==="system"&&window.matchMedia("(prefers-color-scheme: dark)").matches)&&document.documentElement.classList.add("dark");const e=document.getElementById("theme-toggle");e&&e.addEventListener("click",()=>{document.documentElement.classList.toggle("dark");const n=document.documentElement.classList.contains("dark")?"dark":"light";H.savePreferences({...r,theme:n}),h.emit(y.THEME_CHANGED,n)});const a=document.getElementById("info-button");a&&a.addEventListener("click",()=>{N.infoModal&&N.infoModal.open()})}function yt(){h.on(y.ERROR_OCCURRED,r=>{G(r.message||"An error occurred","error")}),h.on(y.NOTIFICATION,r=>{G(r.message,r.type||"info")}),h.on("schedule:show",r=>{var t;N.amortizationSchedule&&(N.amortizationSchedule.show(r),(t=document.getElementById("amortization-container"))==null||t.scrollIntoView({behavior:"smooth"}))})}let z=[];function G(r,t="info"){const e=document.createElement("div"),a=Date.now(),n={success:"bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 border border-gray-700 dark:border-gray-300",error:"bg-red-50 dark:bg-red-900/20 text-red-900 dark:text-red-100 border border-red-200 dark:border-red-800",info:"bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-700"};e.className=`fixed right-4 z-50 px-4 py-3 rounded-lg shadow-lg backdrop-blur-sm animate-fade-in ${n[t]||n.info}`,e.dataset.notificationId=a;const i=16+z.length*76;e.style.top=`${i}px`,e.style.transition="all 0.3s ease-out";const l={success:"✓",error:"✕",info:"ℹ"};e.innerHTML=`
        <div class="flex items-center gap-3">
            <span class="text-lg">${l[t]||l.info}</span>
            <span class="text-sm font-medium">${r}</span>
        </div>
    `,document.body.appendChild(e),z.push(a),setTimeout(()=>{e.style.opacity="0",e.style.transform="translateY(-10px)",setTimeout(()=>{e.remove(),z=z.filter(d=>d!==a),pt()},300)},2700)}function pt(){document.querySelectorAll("[data-notification-id]").forEach((t,e)=>{const a=16+e*76;t.style.top=`${a}px`})}function gt(){const r=document.querySelector("main");if(r&&!document.getElementById("amortization-container")){const t=document.createElement("div");t.id="amortization-container",r.appendChild(t)}}function W(){R.info("Initializing Canadian Mortgage Calculator"),ht(),gt();const r=H.getPreferences();R.debug("Loaded preferences",r),N.calculator=new dt("calculator-container"),R.info("Modern calculator component initialized"),N.amortizationSchedule=new mt("amortization-container"),R.info("Amortization schedule initialized"),N.infoModal=new ut,R.info("Info modal initialized"),yt(),R.info("Application initialized successfully")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",W):W();
//# sourceMappingURL=index-B1sDJBKY.js.map
